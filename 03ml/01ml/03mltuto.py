...
pdf.cell(0, 10, "Machine Learning Mind Map", ln=True)
pdf.image("Machine_Learning_Mind_Map.png", x=10, w=190)  # Adjust 'w' for image width

# Save final PDF
pdf.output("ML_Guide_with_MindMap.pdf")
